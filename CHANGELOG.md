...
- Bumped direct dependencies: `clap` 4.6.1, `geo` 0.33.1, `reqwest` 0.13.4,
  `serde_json` 1.0.150, `tokio` 1.52.3, `zip` 8.6.0.
- Refreshed transitive `rand` to 0.9.4.

## [0.5.1] - 2026-05-27

### Fixed

- Refresh transitive `rustls-webpki` to 0.103.13 to clear
  RUSTSEC-2026-0104.
...
- Add `1nt mcp`, a stdio MCP server exposing `near`, `search`, `spot`,
  `list`, `status`, and `refresh` tools.
